...
// 	// useEffect(() => {
// 	// 	const date_time = getDefaultDateTimeLocal();
...
// 	// 	// 	.toString(36)
// 	// 	// 	.substring(2, 9)}@minimal-app.com`;
// 	// 	const dtStamp = formatIcsStampDate(new Date());
// 	// 	const icsBlob = new Blob(
// 	// 		[
// 	// 			serializeIcsToString({
// 	// 				// ...config,
...
// 	// 	const newUrl = URL.createObjectURL(icsBlob);
...
// 	// 	// };
// 	// }, [dtEnd, _class, dtStart, summary, location, status, description]);
