...
# ```
# {
# "1":"Does the privacy policy affirm that personal data can be transferred outside of the user's country of origin?",
# "2": "Does the privacy policy affirm that personal data transfers are automatically consented to by using the service?",
# "3": "Does the privacy policy affirm that personal data processing is automatically consented to by using the service?"
# }
# ```
# """

# ANALYSIS_PROMPT_2 = """# Role
...
# #### Contact Details:
# Specific contact information (email addresses, phone numbers, and physical addresses) must also be generalized to describe the *method* of contact.
...
# ```
# {
# "1":"We may store and process personal information collected on our site in the United States or any other country in which Corperation Inc. or its agents maintain facilities. "
# "2":"By using our services, you consent to the transfer of your information among these facilities, including those located outside your country."
# "3":"We may store and process personal information collected on our site in the United States or any other country in which Corperation Inc. or its agents maintain facilities. By using our services, you consent to the transfer of your information among these facilities, including those located outside your country."
# }
# ```
# """
